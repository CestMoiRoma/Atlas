...
mcp = FastMCP(
    ...
    instructions=(
        ...
        "'cpu', 'gpu', 'ram', 'mémoire', 'charge du système', 'utilisation', 'performances', "
        "'combien de ram', 'batterie', 'réseau', 'depuis quand le mac est allumé'."
    ),
)
...
def get_mac_metrics() -> dict:
    ...
    Collects CPU, GPU, RAM, network I/O, battery, thread/process counts, and
